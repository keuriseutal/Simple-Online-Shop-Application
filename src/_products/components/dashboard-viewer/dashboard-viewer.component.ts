...
export class DashboardViewerComponent implements OnInit {
  ...
  @Output() itemViewed = new EventEmitter();
  @Output() isItemViewed = new EventEmitter();
  ...
  @Output() filterGadget = new EventEmitter();
  @Output() filterClothing = new EventEmitter();
  @Output() filterMusic = new EventEmitter();
  @Output() filterMerchandise = new EventEmitter();
  @Output() filterAppliances = new EventEmitter();
  ...
  @Output() filterMinPrice = new EventEmitter();
  @Output() filterMaxPrice = new EventEmitter();
